...
public class GameDTO {
    ...
    public GameDTO(Integer player1Id, Integer player2Id, String roomName, Integer bet, Integer player1CardId, Integer player2CardId, String fightLog, Integer winner) {
